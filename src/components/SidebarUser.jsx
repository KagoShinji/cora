import { FilePen, Menu, Star } from "lucide-react";
...
// ✅ Accept sidebarRefreshKey as a prop
function SidebarUser({ isOpen, setOpen, onNewChat, onSelectChat, currentConversationId, sidebarRefreshKey }) {
...
  // ❌ REMOVE THIS LINE: const [sidebarRefreshKey, setSidebarRefreshKey] = useState(0); // This should come from the parent
...
    };
    getConversations();
  }, [sidebarRefreshKey]); // ✅ THIS IS THE CRUCIAL CHANGE: Dependency on the prop
...
    }
    onNewChat(); // This calls the onNewChat function in the parent, which should update sidebarRefreshKey
  };
...
                      chat.id === currentConversationId ? "bg-red-800" : "hover:bg-red-800"
                    }`}
                  >
                    {isOpen ? chat.title : ""}
                  </li>
...
            <h2 className="text-lg font-semibold text-primary mb-4">Rate Satisfaction</h2>
