...
function SuperAdminLogs() {
  ...
  // Sample data -> preserved functionality
  const logs = useMemo(
    () => [
      { description: "User Coby updated profile", timestamp: "March 23, 2025 10:42 AM" },
      { description: "Admin Raven created a new user", timestamp: "March 24, 2025 09:15 AM" },
      { description: "Super Admin logged in", timestamp: "March 25, 2025 08:30 AM" },
      { description: "User Mira deleted an inquiry", timestamp: "March 25, 2025 01:05 PM" },
      { description: "System backup completed successfully", timestamp: "March 26, 2025 12:00 AM" },
    ],
    []
  );
  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-gray-50">
      ...
      >
          ...
          <div className="md:hidden flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs sm:text-sm text-gray-600">
                Latest actions across Super Admin and admins
              </p>
            </div>
          </div>
        ...
        {/* Logs Table — AdminCreatorDashboard style */}
